...
class InterfaceProxy:
    ...
    def GetManagedObjects(self) -> Dict[str, Dict[str, Dict[str, Variant]]]: ...
    def Pair(self) -> None: ...
...
class SystemMessageBus:
    def get_proxy(self, service_name: str, object_path: str,
                  interface_name: Optional[str] = ...) -> InterfaceProxy: ...
